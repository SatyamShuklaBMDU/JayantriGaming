        ...
        <div class="row">
            <div class="col-sm-12 p-0 mt-4">
                <div class="main-header">
                    <h4 class="text-dark fw-bold text-center h2">Withdraw History</h4>
                    <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                        ...
                        <li class="breadcrumb-item  "><a href="#" style="color:black ;"
                                class="text-decoration-none">Withdraw User History</a>
                        </li>
                            ...
                            <table class="table responsive-table  table-striped table-hover shadow-lg">
                                <thead>
                                    <tr class="" style="background-color:#E7EAEA;">
                                        ...
                                        <th scope="col " style="padding: 1.5rem; font-size:1.5rem;">Withdraw History</th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-success" style="padding:1.5rem;">Active</td>
                                        <td>10,000</td>
