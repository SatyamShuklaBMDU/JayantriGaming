                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-3 end-date">
                                        ...
                                        <div class="input-group date d-flex" id="datepicker">
                                            <input type="text" class="form-control " id="txtDate" value="{{$start??''}}"
                                    ...
                                    <div class="col-sm-3 end-date">
                                        ...
                                        <div class="input-group date d-flex" id="datepicker1">
                                            <input type="text" class="form-control" id="txtDate2" value="{{$end??''}}"
                                    ...
                                    <div class="col-md-1 " style="margin-left: -12px;  margin-top:40px;">
                                        <a class="btn bg-light shadow-lg" href="{{ route('all-user') }}">Reset</a>
                                    </div>
                                </div>
                            </form>
                        </div>
                                                ...
                                                <td class="text-success" style="padding:1rem;">
                                                    <div class="select">
                                                        <select name="format" id="format">
                                                            ...
                                                            <option value="block"
                                                                {{ $customer->status == 'block' ? 'selected' : '' }}>Block
                                                            </option>
